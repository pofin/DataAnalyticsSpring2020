...
s0 <- splinefun(cars$dist,cars$speed)
curve(s0(x), add = TRUE,col = 2, n= 101)
s1 <- splinefun(cars$dist, cars$speed, method = "monoH.FC")
curve(s1(x), add = TRUE, col = 3, n = 1001)
s2 <- splinefun(cars$dist, cars$speed, method = "hyman")
curve(s2(x), add = TRUE, col = 4, n = 1001)

data(Ionosphere)
Ionosphere
plot(Ionosphere$v3,Ionosphere$v10)
s0 <- splinefun(Ionosphere$v3,Ionosphere$v10)
curve(s0(x), add = TRUE,col = 2, n= 101)
s1 <- splinefun(Ionosphere$v3, Ionosphere$v10, method = "monoH.FC")
curve(s1(x), add = TRUE, col = 3, n = 1001)
s2 <- splinefun(Ionosphere$v3, Ionosphere$v10, method = "hyman")
curve(s2(x), add = TRUE, col = 4, n = 1001)
...
s0 <- splinefun(Glass$RI,Glass$Na)
curve(s0(x), add = TRUE,col = 2, n= 101)
s1 <- splinefun(Glass$RI, Glass$Na, method = "monoH.FC")
curve(s1(x), add = TRUE, col = 3, n = 1001)
s2 <- splinefun(Glass$RI, Glass$Na, method = "hyman")
curve(s2(x), add = TRUE, col = 4, n = 1001)
